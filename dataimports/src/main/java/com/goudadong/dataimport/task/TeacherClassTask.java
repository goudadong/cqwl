	...
	//日志
		...
		*/
		private void saveData(PageData pData,int flag) throws Exception{
			String []tableMainId = pData.getString("tableMainId").split("\\|");//tableMainId=XH:2004|XQ_ID:0|KCDM:171019  |T_SKBJ:171019-005  |BJDM:2001050303
			if (tableMainId.length>1) {
				...
				pd = hwadee_OpTableService.findByColums_class(pd);
